This is the compiled version of Python MP3 Player for Windows.

The following directory contains the 2 versions of the program: V3 and V4. The directory of each version contain all the resources needed 
