...
The backup directory contains all the backup files the script creates:
...
The resources directory contains all the resources needed to run the script.
    ...
    clear.mp3 is a file used to clear the playback when making some changes for the file in use.
